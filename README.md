...
The screenshot is showing the overview of the Attack Simulation, and what is the purpose of this training and the simulation name.
...
The second screenshot is showing that I chose the Social Engineer attack by selecting the attachment link in an email as the approach.
...
The last screenshot shows the message that the employee (Allan Weston) sees when they fail the Social Engineering attack. The employee has to go through a mandatory Cybersecurity training.
